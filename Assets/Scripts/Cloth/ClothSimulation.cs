...
public class ClothSimulation : MonoBehaviour {
    ...
    void InitComputeBuffer() {
        ...
        anchorRowAndCol_buffer = new ComputeBuffer(anchorCount, 8);
        anchorRowAndCol_buffer.SetData(anchorRowAndCol);
        anchorRelPos_buffer = new ComputeBuffer(anchorCount, 16);
    ...
    void InitCRCS() {
        CRCS_handle = collisionResponseCS.FindKernel("CollisionResponse");
        ...
        collisionResponseCS.SetBuffer(CRCS_handle, "_Position", p1_bufferPool[1]);

        // set dispatchdim
        CRCS_dispatchDim.x = verCountPerCol / 16;
        CRCS_dispatchDim.y = verCountPerRow / 16;
